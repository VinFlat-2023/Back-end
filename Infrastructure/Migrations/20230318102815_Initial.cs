    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "HCM", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(470), null, "3214324523", "12321fdsg45adsa", "renter1@mail.com", "Nguyen Van A", "Male", null, null, "renter1", "0123543125", true, null, "renter1" },
                    { 2, "Hue", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(475), null, "3214324523", "dsavvf", "renter2@mail.com", "Nguyen Van B", "Male", null, null, "renter2", "0123543125", true, null, "renter2" }
                });
            ...
            migrationBuilder.InsertData(
                table: "RoomTypes",
                columns: new[] { "RoomTypeId", "Description", "NumberOfSlots" },
                values: new object[,]
                {
                    { 1, "Room type id 1 : 2 slots", 2 },
                    { 2, "Room type id 2 : 2 slots", 2 },
                    { 3, "Room type id 3 : 2 slots", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, "HN", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(479), null, "3214324523", "ewasdv12344", "renter4@mail.com", "Nguyen Van D", "Female", null, null, "renter4", "0123543125", true, 1, "renter4" },
                    { 5, "HCM", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(480), null, "3214324523", "ewasdv12344", "trankhaimnhkhoi10a3@mail.com", "Tran Minh Khoi", "Male", null, null, "123456789", "0123543125", true, 1, "minhkhoi10a3" },
                    { 6, "HCM", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(482), null, "3214324523", "ewasdv12344", "trankhaimnhkhoi@mail.com", "Tran Minh Khoi", "Male", null, null, "123456789", "0123543125", true, 1, "minhkhoi" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, 0, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(786), "Detail for invoice 1", null, null, 1, "Hoá đơn điện tử cho renter 1", null, 1, true },
                    { 2, 3, 0, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(787), "Detail for invoice 2", null, null, 1, "Hoá đơn điện tử cho renter 2", null, 2, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "DN", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(477), null, "3214324523", "123221ad145ad423sa", "renter3@mail.com", "Nguyen Van C", "Female", null, 2, "renter3", "0123543125", true, 1, "renter3" },
                    { 7, "HCM", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(484), null, "3214324523", "ewasdv12344", "khoitkmse150850@fpt", "Tran Minh Khoi", "Male", null, 1, "123456789", "0123543125", true, 1, "minhkhoitkm" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, 4, 0, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(788), "Detail for invoice 3", null, null, 1, "Hoá đơn điện tử cho renter 3", null, 3, false },
                    { 4, 2, 0, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(789), "Detail for invoice 3 (2)", null, null, 1, "Hoá đơn điện tử cho renter 3 (2)", null, 3, false },
                    { 5, 2, 0, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(790), "Detail for invoice 3 (3)", null, null, 1, "Hoá đơn điện tử cho renter 3 (3)", null, 3, false },
                    { 6, 2, 0, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(791), "Detail for invoice 3 (4)", null, null, 1, "Hoá đơn điện tử cho renter 3 (4)", null, 3, true },
                    { 7, 2, 0, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(792), "Detail for invoice 3 (5)", null, null, 1, "Hoá đơn điện tử cho renter 3 (5)", null, 3, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Contract for renter 1", "Active", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 2, 16, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(823), "Contract description for renter 1", null, 2, "No image", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(829), 0m, 1800000m, 0m, 0m, 1, 1, new DateTime(2023, 2, 21, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(829) },
                    { 2, 2, "Contract for renter 2", "Active", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 2, 17, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(832), "Contract description for renter 2", null, 3, "No image", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(833), 0m, 2800000m, 0m, 0m, 2, 1, new DateTime(2023, 2, 19, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(833) },
                    { 3, 3, "Contract for renter 3", "Active", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 2, 17, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(834), "Contract description for renter 3", null, 3, "No image", new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(835), 120m, 2800000m, 10000m, 1000m, 3, 2, new DateTime(2023, 2, 19, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(835) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, null, 3, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(688), "Sự cố 1", null, null, "Active", 1 },
                    { 2, 2, null, 3, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(690), "Sự cố 2", null, null, "Processing", 2 },
                    { 3, 2, null, 3, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(691), "Sự cố 3", null, null, "Completed", 3 },
                    { 4, 2, null, 3, new DateTime(2023, 3, 18, 10, 28, 15, 160, DateTimeKind.Utc).AddTicks(691), "Sự cố 4", null, null, "Active", 1 }
                });
