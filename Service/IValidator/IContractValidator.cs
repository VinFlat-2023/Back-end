...
public interface IContractValidator
{
    ...
    Task<ValidatorResult> ValidateParams(ContractCreateRequest? obj, int buildingId,
        CancellationToken cancellationToken);

    Task<ValidatorResult> ValidateParams(ContractCreateUserExistRequest? obj, int? renterId, int buildingId,
        CancellationToken cancellationToken);
}